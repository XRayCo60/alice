...
partial class Program
{
    ...
    static async Task HandleTankInfoCallback(CallbackQuery cb, string[] parts, CancellationToken ct)
    {
        ...
        string info = tid switch
        {
            ...
            "T28" => "🇷🇺 T-28\n\n⚖️ ۲۵ تن | 👥 خدمه ۶\n🔫 هویتزر ۷۶.۲mm KT-28 — نفوذ فقط ۳۴mm در ۵۰۰ متر\n💥 گلوله انفجاری ۶۲۱ گرم TNT — قوی‌ترین ضدسنگر\n🎯 آهنگ آتش ۴ گلوله/دقیقه | فقط ۶۹ گلوله\n🛡 زره ۳۰mm جلو / ۲۰mm پهلو\n⚡ ۳۷km/h جاده، ۱۸ آفرود | اطمینان ۸۲٪\n⚠️ نقش: پشتیبانی پیاده — در نبرد تانک‌به‌تانک ضعیف است\n💰 هر ۵ تانک: ۳K آهن + ۳K پول",
